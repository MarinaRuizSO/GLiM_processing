...
dem_path = ['./nevada/']#['/exports/csce/datastore/geos/users/s1440040/LSDTopoTools/data/ExampleTopoDatasets/ChiAnalysisData/dems_to_process/pyrenees/input_data/']
save_path = './nevada/'
dem_counter = 0 
for dem in dem_names:
    ...
    file_name = dem_path[dem_counter] + dem_names[dem_counter]
    ...
    input_raster = gdal.Open(dem_path[dem_counter]+output_name)
